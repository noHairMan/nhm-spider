...
from nhmspider.utils.module_loading import import_string
from nhmspider.utils.request import request_fingerprint
from nhmspider.utils.signal import SignalManager
...
class Crawler(CrawlerABC):
    def __init__(self, spider_class: SpiderABC):
        ...
        base_downloader_class = import_string("nhmspider.core.interface.DownloaderABC")
